...
**ClassMap** הוא **דשבורד כיתתי למורים** – אפליקציית ווב לניתוח פדגוגי המבוססת על שני מקורות נתונים: אירועי התנהגות וציונים. האתר מבית **ToledanoEdTech**.  
השם המוצג באתר: **"ClassMap"**, והכותרות בעברית: **"דשבורד כיתתי"**, **"מערכת מעקב פדגוגית"**.
...
- **אלגוריתם ציון סיכון** – מתחיל מ-10 (סיכון נמוך) ומוריד לפי: ממוצע ציונים, מגמת ציונים, התנהגות אחרונה (12 אירועים), מגמת התנהגות, סך אירועים שליליים, חיסורים. נותן בונוס קטן למגמה משתפרת ולמאזן חיובי (חיוביים>שליליים). ראה הערות ב-`calculateStudentStats` ב-`processing.ts`.
...
ניווט: לוגו "ClassMap" מחזיר למסך ההעלאה (ומנקה state).
